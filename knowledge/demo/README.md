# ðŸ§ª Reference Demo / Sandbox Application ("To-Do App")
...
## ðŸŽ¯ Demo Navigation Map (Exhaustive)

### ðŸ“ 0. Project Lifecycle & Backlog
Official planning, Scrum artifacts, and taxonomy of deliverables.
*   ðŸ‘‰ **[Project Hub (PRD & Backlog)](./project/README.md)**

### ðŸ“‹ 1. Functional & Business Layer of the Sandbox
...
### ðŸ—ï¸ 2. Technical Layer of the Demo
...
*   ðŸ‘‰ **[Pattern Verification Matrix (Sandbox Scope)](./technical/sandbox-verification.md)** *(Check which ADRs are physically proven in code)*

### ðŸš€ 3. Implemented Atomic Use Cases
