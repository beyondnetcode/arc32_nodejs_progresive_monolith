...
*   ⚠️ **Maintenance:** Humans must remember to update `AGENTS.md` if changing a critical test command, or risk disorienting the agent. It is recommended to add a rule within the file itself reminding the Agent to update it upon architectural changes.
