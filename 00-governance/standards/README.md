...
*   **[🏛️ Corporate Multi-Runtime Blueprint](./01-architecture/reference-blueprint.md)** *(Mandatory Reading)*
*   [C4 Spec Container Topology](./01-architecture/c4-topology-spec.md)
*   [Strategic CAP Theorem Analysis](./01-architecture/cap-strategic-analysis.md)
*   [Multi-Cloud Deployment Scenarios](./01-architecture/multi-cloud-deployment-scenarios.md)
*   [Authoritative Tech Stack](./01-architecture/authoritative-tech-stack.md)
*   [Quick Stack Summary](./01-architecture/tech-stack-summary.md)

### 📜 Phase 02: Architectural Decision Records (ADRs)
The consolidated and classified history of the active 44 technical decisions.
*   👉 **[Central ADR Navigator](./02-adrs/README.md)**
    *   ⚡ *Jump To:* [🌐 Core](./02-adrs/README.md#universal-core) | [🟢 Node.js](./02-adrs/README.md#nodejs-typescript) | [🔵 .NET](./02-adrs/README.md#net-c) | [🟣 Mobile](./02-adrs/README.md#android-native)
...
*   [API Gateway Plugin Manual (Kong/Traefik)](./03-engineering/gateway-guidelines.md)
*   [Vendor & Supply Chain Risk Assessment](./03-engineering/vendor-risk-assessment.md)

### 🚦 Phase 04: Governance and Delivery
*   [Release and Audit Strategy (Nx)](./04-governance/release-audit-strategy.md)

### 🚀 Phase 05: Onboarding
*   **[Quick Start Guide for New Products](./05-onboarding/product-quick-start.md)**
