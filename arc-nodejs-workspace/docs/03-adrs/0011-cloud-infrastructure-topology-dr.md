# ADR 0011: Cloud Infrastructure Topology and Disaster Recovery (DR) Strategy
...
1. **Container Orchestration**: The Reference Skeleton workloads will be deployed on a managed orchestrator (e.g., Azure Kubernetes Service or Azure Container Apps) capable of Horizontal Pod Autoscaling (HPA) to dynamically react to traffic spikes.
