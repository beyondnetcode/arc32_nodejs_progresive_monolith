# ðŸ“œ ADR-0028 â€” Self-Hosted, Open-Source Infrastructure for Hybrid & On-Premise Deployments
...
The To-Do Reference Template must be capable of operating under a hybrid deployment model: functioning as a high-density, multi-tenant SaaS platform in public clouds (AWS, GCP) while simultaneously supporting standalone, air-gapped, on-premise installations inside secure client corporate networks.
...
### Positive
- **100% On-Premise & Air-Gap Ready:** The complete Reference Template can be deployed anywhere, from a local developer's laptop to an air-gapped corporate data center, with zero cloud dependencies.
