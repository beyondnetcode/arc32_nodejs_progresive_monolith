...
* **Framework Agnosticism**: If Reference Skeleton decides to migrate from NestJS/TypeORM to another framework, the core business domain remains 100% untouched.
