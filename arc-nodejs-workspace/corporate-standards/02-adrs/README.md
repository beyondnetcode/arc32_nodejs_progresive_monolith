# 📜 Navegador de Decisiones Arquitectónicas (ADRs)

Bienvenido al repositorio legal del sistema. Todas las decisiones aquí contenidas han sido aprobadas por la Junta Arquitectónica Corporativa.

---

## 🧠 1. Core Universales (Agnósticos de Runtime)
...
*   **[ADR 0040: Multi-Runtime Matrix & Contracts](./core/0040-multi-runtime-selection-contracts.md)** *(Gobernanza Raíz)*

---

## 🟢 2. Ecosistema Node.js / TypeScript
Decisiones ligadas al runtime principal de APIs y BFFs.
