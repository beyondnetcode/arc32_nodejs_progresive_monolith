...
The core domain model utilizes a **Hybrid Audit Strategy** ([ADR-0016](../../../architecture/adrs/core/0016-immutable-business-audit-trail.md)). Every transactional table inherits standard auditing columns, and an external immutable ledger tracks the historical delta changes.
