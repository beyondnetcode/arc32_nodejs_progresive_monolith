...
2. **APIs Comerciales Federadas (AWS Bedrock, Azure AI) ÚNICAMENTE si existe un DPA firmado** que prohíba el reentrenamiento del modelo con nuestros datos.
...
* **Proveedor Corporativo Único (ej. Solo OpenAI):** Descartado para evitar Vendor Lock-In en caídas prolongadas de servicio; preferimos estrategia multi-cloud agnóstica vía adaptadores unificados.
