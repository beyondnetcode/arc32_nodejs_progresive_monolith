...
*   👉 **[ULPMS Functional Specifications & Use Cases](./docs/functional/)**: Details the complete functional scope, glossary, ER diagrams, and permission matrices of the User Life-Cycle & Permissions Management System (ULPMS).
