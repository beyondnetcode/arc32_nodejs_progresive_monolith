...
*   👉 **[ULPMS Functional Specifications & Use Cases](./docs/functional/index.md)**: Details the complete functional scope, glossary, ER diagrams, and permission matrices of the User Life-Cycle & Permissions Management System (ULPMS).
