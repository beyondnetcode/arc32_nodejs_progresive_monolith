...
See [conceptual-data-model.md](file:///d:/Users/aarroyo/personal/sources/ums/ums-workspace/docs/01-requirements/conceptual-data-model.md) for full properties.
...
Refer to case details in [UC-09: Resolve Hierarchical System Configuration](file:///d:/Users/aarroyo/personal/sources/ums/ums-workspace/docs/01-requirements/usecases/uc-09-resolve-hierarchical-config.md).
...
1.  **Traceable Business Needs**: Verified. The business objectives in [objectives.md](file:///d:/Users/aarroyo/personal/sources/ums/ums-workspace/docs/00-product/objectives.md) match the technical targets listed in the NFR Backlog.
