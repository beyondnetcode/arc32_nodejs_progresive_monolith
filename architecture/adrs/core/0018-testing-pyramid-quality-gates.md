...
3. **e2e Layer (Complete)**: Deploy isolated `supertest` routines orchestrating full HTTP routes (Controller âž” Service âž” Database) testing actual external boundary security and transport.
