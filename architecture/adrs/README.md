...
## <a name="universal-core"></a>ðŸ§  1. Universal Core (Runtime Agnostic)
...
## <a name="nodejs-typescript"></a>ðŸŸ¢ 2. Node.js / TypeScript Ecosystem
...
## <a name="net-c"></a>ðŸ”µ 3. .NET (C#) Ecosystem
...
## <a name="android-native"></a>ðŸŸ£ 4. Android Native (Kotlin) Ecosystem
...
â†’ [View all AI ADRs](../../governance/standards/ai-augmented/06-adrs/README.md)
